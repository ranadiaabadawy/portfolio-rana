      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center relative min-h-[600px]">
          ...
          <div className="text-center mt-8 text-white">
            ...
            <p className="text-purple-200">Ready for your next delicious meal?</p>
          </div>
        </div>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-purple-200 text-lg">We're so happy to have you back.</p>
          </div>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="text-left">
                  <Link
                    ...
                    className="text-purple-200 hover:text-emerald-400 text-base transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
                ...
                <div className="text-center pt-2">
                  <span className="text-purple-200 text-base">Don't have an account? </span>
                  <Link
                    href="/signup"
